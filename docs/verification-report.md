...
Baseline: 2026-07-29, Go 1.24, macOS arm64 (Apple M2 Max). CI repeats the
...
| Supply chain | Four target builds, SHA-256, SPDX SBOM, release manifest, signed GitHub/Sigstore attestations |
...
- Final approval of the IPC/security/compatibility baseline is a maintainer
  governance decision and cannot be self-approved by implementation code.
