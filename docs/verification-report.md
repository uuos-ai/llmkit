...
| Client isolation | Per-token client identity, client-local user binding, cross-client target rejection, atomic client-cache replacement, shared-store request fencing and in-flight cancellation |
